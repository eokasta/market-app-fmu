...
package br.fmu.appentrega.Helper;
...
public class TinyDB {
    ...
    public ArrayList<ComidaDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ComidaDomain> playerList =  new ArrayList<ComidaDomain>();

        for(String jObjString : objStrings){
            ComidaDomain player  = gson.fromJson(jObjString,  ComidaDomain.class);
    ...
    public void putListObject(String key, ArrayList<ComidaDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ComidaDomain player: playerList){
