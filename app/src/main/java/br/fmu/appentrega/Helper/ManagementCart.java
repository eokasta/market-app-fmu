...
public class ManagementCart {
    ...
    public static void insertFood(ComidaDomain item){
    ...
    public void plusNumberFood(ArrayList<ComidaDomain>listFood, int position, ChangeNumberItemsListener changeNumberItemsListener){
